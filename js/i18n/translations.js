...
window.GH_TRANSLATIONS = {
  uk: {
    ...
    index: {
      ...
      slide2Title: "IT, SAP, бухгалтерія<br />і реклама — в одній команді",
      ...
      slide3Sub: "Реклама, звітність, SAP і розробка під ключ",
      ...
      f4Title: "Впровадження та пристосування SAP",
      f4Text: "Запуск і налаштування SAP ERP/S/4HANA під ваш бізнес: модулі FI, CO, MM, SD, ABAP-розширення, міграція даних і супровід користувачів.",
      more: "Детальніше",
      ...
      step2Text: "IT, SAP, облік чи реклама — підключаємо потрібних фахівців одразу.",
  ...
  en: {
    ...
    index: {
      ...
      slide2Title: "IT, SAP, accounting<br />and marketing — one team",
      ...
      slide3Sub: "Ads, reporting, SAP, and development — turnkey",
      ...
      f4Title: "SAP implementation & customization",
      f4Text: "Deploy and tailor SAP ERP/S/4HANA for your business: FI, CO, MM, SD modules, ABAP extensions, data migration, and user support.",
      more: "Learn more",
      ...
      step2Text: "IT, SAP, accounting, or marketing — we assign the right experts immediately.",
